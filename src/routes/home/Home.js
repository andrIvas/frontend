  ...
  render() {
    return (
      <div className="hero_img sectionBS">
        <img src="images/hero_1.jpg" role="presentation" />
        <div className="hero_content">
                  ...
                  <form action="#">
                    <div className="form-row">
                      <div className="form-cell cell-s1 select-box-v1 select-multi-v1 _no-bdr">
                        <select
                          className="typeSelect select2" data-dropdown-className="dropdown-v1"
          ...
          <div className="hero_scroll">
            ...
            <Link className="gl_link scrollTo" to="/section_1" />
          </div>
        </div>
            ...
            <ul className="features-list">
              <li>
                <div className="feature-unit">
                  <div className="feature-logo"><img src="images/feature_border.png" role="presentation" />
                    <div className="feature-fraction fraction-v1">С&nbsp;мебелью</div>
                    <div className="feature-fraction fraction-v2">Остальные</div>
                    <div className="feature-icon"><img src="images/interior-sofa-chair.svg" role="presentation" /></div>
                  </div>
              ...
              <li>
                <div className="feature-unit">
                  <div className="feature-logo"><img src="images/feature_border_2.png" role="presentation" />
                    ...
                    <div className="feature-icon"><img src="images/building-apartment.svg" role="presentation" /></div>
                  </div>
              ...
              <li>
                <div className="feature-unit">
                  <div className="feature-logo"><img src="images/feature_border.png" role="presentation" />
                    <div className="feature-fraction fraction-v1">С мебелью</div>
                    <div className="feature-fraction fraction-v2">Остальные</div>
                    <div className="feature-icon"><img src="images/time-clock-hour.svg" role="presentation" /></div>
                  </div>
